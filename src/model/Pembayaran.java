...
public class Pembayaran {
    ...
    public Pembayaran(int id, Pembeli pembeli, Pegawai pegawai, double sub_total, String tanggal_pesanan, String status_pembayaran) {
        this.id = id;
    ...
    public Pembayaran(int id_pegawai, int id_pembeli, double sub_total, String tanggal_pesanan, String status_pembayaran) {
